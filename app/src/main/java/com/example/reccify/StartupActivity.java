...
import com.example.reccify.databinding.ActivityStartupBinding;

public class StartupActivity extends AppCompatActivity {

    public void startUpRequest(View view) {
        Intent login = new Intent(this, SpotifyLoginActivity.class);
        startActivity(login);
    }
